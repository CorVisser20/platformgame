...
namespace PlatformGame
{
    public partial class Form1 : Form
    {
        ...
        private void MainTimerEvent(object sender, EventArgs e)
        {
            ...
            if (enemySaw.Left < pictureBox8.Left || enemySaw.Left + enemySaw.Width > pictureBox8.Left + pictureBox8.Width)
            {
            ...
            if (enemy1.Left < pictureBox18.Left || enemy1.Left + enemy1.Width > pictureBox18.Left + pictureBox18.Width)
            {
